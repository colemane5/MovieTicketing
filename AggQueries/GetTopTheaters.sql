...
BEGIN
	...
	WITH MonthlyTheaterSales AS(
		...
		INNER JOIN MovieDatabase.MovieDB.Theater T ON MS.TheaterID = T.TheaterID
		LEFT JOIN MovieDatabase.MovieDB.TicketPurchase TP ON MS.MovieID = TP.MovieShowtimeID
